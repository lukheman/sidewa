<div>
        ...
        <div class="modal-backdrop-custom" wire:click.self="closeModal">
            <div class="modal-content-custom" wire:click.stop style="max-width: 600px;">
                ...
                <form wire:submit="save">
                    <div class="mb-3">
                        <label for="masyarakat_id" class="form-label">Pemohon <span
                    ...
                    <div class="mb-3">
                        <label for="jenis_surat_id" class="form-label">Jenis Surat <span
                                style="color: var(--danger-color);">*</span></label>
                        <select class="form-select @error('jenis_surat_id') is-invalid @enderror" id="jenis_surat_id"
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            <label for="tanggal_pengajuan" class="form-label">Tanggal <span
                                    style="color: var(--danger-color);">*</span></label>
    ...
    <x-admin.confirm-modal :show="$showDeleteModal" title="Konfirmasi Hapus"
        message="Apakah Anda yakin ingin menghapus pengajuan surat ini?" on-confirm="delete" on-cancel="cancelDelete"
