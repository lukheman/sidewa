<div>
    <x-admin.page-header title="Manajemen Pengaduan" subtitle="Kelola pengaduan warga">
        <x-slot:actions>
            ...
            <div class="modal-content-custom" wire:click.stop style="max-width: 600px;">
                <div class="modal-header-custom">
                    <h5 class="modal-title-custom">
                        {{ $editingId ? 'Edit Pengaduan' : 'Tambah Pengaduan Baru' }}
                    </h5>
                ...
                <form wire:submit="save">
                    ...
                    <div class="d-flex justify-content-end gap-2">
                        ...
                        <x-admin.button type="submit" variant="primary">
                            {{ $editingId ? 'Simpan Perubahan' : 'Tambah Pengaduan' }}
                        </x-admin.button>
                    </div>
                </form>
            </div>
