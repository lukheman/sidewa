        ...
        <div style="width: 100%; max-width: 420px;">
            <div
                ...
                <div style="text-align: center; margin-bottom: 2rem;">
                    ...
                    <h1 style="font-size: 1.75rem; font-weight: 700; color: #064e3b; margin-bottom: 0.5rem;">Portal
                        Masyarakat</h1>
                    <p style="color: #047857; font-size: 0.95rem;">Masuk dengan Email atau NIK</p>
                </div>
                ...
                <form wire:submit="submit">
                    ...
                    <div style="margin-bottom: 1.25rem;">
                        <label for="login"
                            style="display: block; margin-bottom: 0.5rem; color: #064e3b; font-weight: 500;">Email atau
                            NIK</label>
                        <div style="position: relative;">
                            ...
                            <input type="text" wire:model="login" id="login"
                                style="width: 100%; height: 52px; border: 2px solid {{ $errors->has('login') ? '#ef4444' : '#d1fae5' }}; border-radius: 12px; padding: 0 1rem 0 3rem; font-size: 1rem; background: #f8fafc; transition: border-color 0.2s;"
                                placeholder="Masukkan email atau NIK" autofocus>
                        </div>
                        @error('login')
                    ...
                    <div style="margin-bottom: 1.5rem;">
                        ...
                        <div style="position: relative;">
                            ...
                            <input type="password" wire:model="password" id="password"
                                style="width: 100%; height: 52px; border: 2px solid {{ $errors->has('password') ? '#ef4444' : '#d1fae5' }}; border-radius: 12px; padding: 0 3rem 0 3rem; font-size: 1rem; background: #f8fafc;"
                    ...
                    <div
                        ...
                        <label
                            style="display: flex; align-items: center; gap: 0.5rem; cursor: pointer; color: #047857;">
                            <input type="checkbox" wire:model="remember"
                                style="width: 1rem; height: 1rem; border-radius: 4px;">
                            Ingat saya
                        </label>
                    </div>
